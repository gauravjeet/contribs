...
class CouponRedemptionForm extends FormElement {
  ...
  public static function processForm(array $element, FormStateInterface $form_state, array &$complete_form) {
    ...
    $element['coupons'] = CouponRedemptionForm::buildAdjustmentsTable($element, $order);
    $element['code'] = [
      '#type' => 'textfield',
      '#title' => $element['#code_title'],
   ...
   *   The element array.
   */
  public static function buildAdjustmentsTable(array $element, OrderInterface $order) {
